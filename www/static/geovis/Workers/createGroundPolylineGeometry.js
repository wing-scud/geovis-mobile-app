...
define(['./when-cbf8cd21', './Check-35e1a91d', './Math-69007a69', './Cartesian2-43e3a3be', './Transforms-5b69e02c', './RuntimeError-f4c64df1', './WebGLConstants-95ceb4e9', './ComponentDatatype-607c9a0c', './GeometryAttribute-d9d9a394', './EncodedCartesian3-29a09d7b', './IntersectionTests-efb488bd', './Plane-c6b92a10', './WebMercatorProjection-3da37aae', './arrayRemoveDuplicates-d96adeb6', './ArcType-2b58731c', './EllipsoidRhumbLine-357c11e7', './EllipsoidGeodesic-007422da'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, EncodedCartesian3, IntersectionTests, Plane, WebMercatorProjection, arrayRemoveDuplicates, ArcType, EllipsoidRhumbLine, EllipsoidGeodesic) { 'use strict';
  ...
  function generateGeometryAttributes(
    ...
    for (i = 0; i < segmentCount; i++) {
      ...
      var minHeight = -1e5;//minMaxHeights.minimumTerrainHeight;
      var maxHeight = 1e5;//minMaxHeights.maximumTerrainHeight;
