...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.cartesinsToLonlats = cartesinsToLonlats;
	exports.computeModelMatrix = computeModelMatrix;
	...
	function cartesinsToLonlats(positions) {
	  var lonlats = [];
	  positions.map(function (pos) {
	    var carto = GeoVis.Cartographic.fromCartesian(pos);
	    var lonlat = [GeoVis.Math.toDegrees(carto.longitude), GeoVis.Math.toDegrees(carto.latitude)];
	 ...
	 */
	var matrix3Scratch = new GeoVis.Matrix3();

	function computeModelMatrix(cartesian, orientation) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ExtendProps = __webpack_require__(12);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.emitEntity = exports.unserializeEntity = exports.unserialize = undefined;
	    ...
	    return _regenerator2.default.wrap(function _callee3$(_context3) {
	      while (1) {
	        switch (_context3.prev = _context3.next) {
	          case 0:
	            if (!drawHelper._plots.get(options.id)) {
	              _context3.next = 2;
	              break;
	            }
	          ...
	          case 31:
	            ...
	            drawHelper._plots.set(entity.id, entity);
	...
	var emitEntity = exports.emitEntity = function () {
	  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee4(options, drawHelper, mode) {
	    var entity;
	    return _regenerator2.default.wrap(function _callee4$(_context4) {
	      while (1) {
	        switch (_context4.prev = _context4.next) {
	          ...
	          case 4:
	            _context4.t0 = options.type;
	            _context4.next = _context4.t0 === _Types2.default.SPACE_POLYGON ? 7 : _context4.t0 === _Types2.default.CLASSIFY_POLYGON ? 7 : _context4.t0 === _Types2.default.PROJ_POLYGON ? 7 : _context4.t0 === _Types2.default.GROUND_POLYGON ? 7 : _context4.t0 === _Types2.default.SPACE_POLYLINE ? 9 : _context4.t0 === _Types2.default.PROJ_POLYLINE ? 9 : _context4.t0 === _Types2.default.GROUND_POLYLINE ? 9 : _context4.t0 === _Types2.default.CIRCLE ? 11 : _context4.t0 === _Types2.default.WALL ? 13 : _context4.t0 === _Types2.default.RECTANGLE ? 15 : _context4.t0 === _Types2.default.TEXT_MARKER ? 17 : _context4.t0 === _Types2.default.IMAGE_MARKER ? 19 : _context4.t0 === _Types2.default.LABEL_MARKER ? 21 : _context4.t0 === _Types2.default.FLAG_MARKER ? 21 : _context4.t0 === _Types2.default.GROUND_TEXT ? 23 : _context4.t0 === _Types2.default.ICON ? 25 : 27;
	            break;
	  ...
	  return function emitEntity(_x7, _x8, _x9) {
	...
	var _save_polygon = __webpack_require__(15);

	var _save_polyline = __webpack_require__(32);

	var _save_circle = __webpack_require__(33);

	var _save_wall = __webpack_require__(35);

	var _save_rectangle = __webpack_require__(36);

	var _save_marker = __webpack_require__(39);

	var _save_scene = __webpack_require__(49);

	var _save_groundText = __webpack_require__(52);
	...
	function serializeEntity(entity) {
	  switch (entity.type) {
	    ...
	    case _Types2.default.CLASSIFY_POLYGON:
	      return (0, _save_polygon.serializeClassify)(entity);
	    ...
	    case _Types2.default.TEXT_MARKER_NEW:
	...
	function serialize() {
	  ...
	  // drawHelper.features.markers._markerMap.forEach(marker => {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var unserializePlot = exports.unserializePlot = function () {
	  var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(options, drawHelper, mode) {
	    var result, poly;
	    return _regenerator2.default.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	            ...
	            if (options.animator) {
	              options.animator = undefined;
	            }
	            result.id = options.id;
	            result.name = options.name || "队标标绘";
	            result.type = options.type;
	            result.outlineWidth = options.outlineWidth;
	            result.fillColor = (0, _props.loadProp)("color", options.fillColor);
	            result.outlineColor = (0, _props.loadProp)("color", options.outlineColor);
	            result.highLightColor = (0, _props.loadProp)("color", options.highLightColor);
	            result.lineType = options.lineType;
	            result.inlineColor = (0, _props.loadProp)("color", options.inlineColor);
	            result.inlineWidth = options.inlineWidth;
	            result.fillType = options.fillType;
	            result.infillColor = (0, _props.loadProp)("color", options.infillColor);
	            result.animate = options.animate;
	            result.fill = options.fill;
	            result.elevationMode = options.elevationMode;
	            if (options.fillLineType) {
	              result.fillLineType = options.fillLineType;
	              result.fillLineColor = (0, _props.loadProp)("color", options.fillLineColor);
	            }
	            poly = new _PlotShape2.default(_extends({}, result, { drawHelper: drawHelper }));
	  ...
	  return function unserializePlot(_x, _x2, _x3) {
	    return _ref.apply(this, arguments);
	  };
	}();

	exports.serializePolygon = serializePolygon;
	exports.serializeClassify = serializeClassify;
	...
	var _PlotShape = __webpack_require__(24);
	...
	var _websocket = __webpack_require__(28);
	...
	function serializeClassify(entity) {
	  var poly = {};
	  poly.isPolygon = true;
	  poly.type = entity.type;
	  poly.id = entity.id;
	  ...
	  poly.computed = entity.computed;
	  poly.material = (0, _props.saveProp)("material", entity.material);
	  poly.fillColor = (0, _props.saveProp)("color", entity.fillColor);
	  poly.height = entity.height;
	  poly.extrudedHeight = entity.extrudedHeight;
	  poly.props = _ExtendProps2.default.pack(entity.props);
	  return poly;
	}
	...
	function unserializePolygon(params, drawHelper, mode) {
	  ...
	  if (options.isPolygon) {
	    ...
	    if (options.type === _Types2.default.CLASSIFY_POLYGON) {
	      options.fillColor = (0, _props.loadProp)("color", options.fillColor);
	      poly = new _Classify2.default(_extends({}, options, { drawHelper: drawHelper }));
	      if (mode === "3d") {
	        primitives.add(poly);
	      }
	    } else {
	...
	function serializePlot(entity, drawHelper) {
	  ...
	  // result.plotGeometrys = entity.plotGeometrys.map(geom =>
	  //   savePlotGeometry(geom)
	  // );
	  ...
	  result.fillLineType = entity.fillLineType;
	  result.fillLineColor = (0, _props.saveProp)("color", entity.fillLineColor);
	  result.elevationMode = entity.elevationMode;
	  result.elevationHeight = entity.elevationHeight;
	  result.animate = entity.animate;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ChangeablePrimitive2 = __webpack_require__(17);
	...
	var _geometryHelper = __webpack_require__(18);
	...
	var Polygon = function (_ChangeablePrimitive) {
	  ...
	  function Polygon(options) {
	    ...
	    _this.deleted = function () {
	      ...
	      _this.drawHelper._plots.delete(_this.id);
	      _this.drawHelper.mouseOutObject = undefined;
	    };
	        ...
	        if (this.type === _Types2.default.GROUND_POLYLINE || this.type === _Types2.default.GROUND_POLYGON) {
	          ...
	          this._primitive = new GeoVis.ClassificationPrimitive({
	            geometryInstances: new GeoVis.GeometryInstance({
	              ...
	              pickPrimitive: this,
	              attributes: {
	                color: GeoVis.ColorGeometryInstanceAttribute.fromColor(this.fillColor),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _CoplanarPolygon = __webpack_require__(21);
	...
	function getGeometry(entity) {
	  if (entity.plotGeometrys && entity.plotGeometrys.length > 0) {
	    (0, _material.createFillLine)(entity);
	    var symbolPlot = [];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.linefill = exports.outLine = exports.inLine = exports.dynamicMaterial = exports.imageMaterial = undefined;
	exports.createLineAppearance = createLineAppearance;
	exports.createFillAppearance = createFillAppearance;
	exports.createLineFill = createLineFill;
	exports.createFillLine = createFillLine;

	var _lineFill = __webpack_require__(20);
	...
	function createLineFill(entity, type, color) {
	  var polylineBatch;
	  var bbox = (0, _lineFill.getBBox)(entity);
	  var lines = (0, _lineFill.getSectLine)(type, bbox);
	  var polygons = (0, _lineFill.getPolygon)(entity);
	  polylineBatch = (0, _lineFill.lineInterSect)(lines, polygons, color);
	  return polylineBatch;
	}

	function createFillLine(entity) {
	  if (!entity.plotGeometrys) return;
	  if (entity.fillLineType == "default" || !entity.fill || !entity.visible) {
	    if (entity.polylineBatch) {
	      entity.polylineBatch.removeFrom(entity.drawHelper.features);
	    }
	  } else {
	    var polylineBatch = createLineFill(entity, entity.fillLineType, entity.fillLineColor);
	    if (entity.polylineBatch) {
	      entity.polylineBatch.removeFrom(entity.drawHelper.features);
	    }
	    entity.polylineBatch = polylineBatch;
	    entity.polylineBatch.addTo(entity.drawHelper.features);
	  }
	}
...
/***/ (function(module, exports) {
	...
	exports.getSectLine = getSectLine;
	exports.getPolygon = getPolygon;
	exports.lineInterSect = lineInterSect;
	// function createLineFill(entity, type, color) {
	//   type = "gridLine";
	//   color =GeoVis.Color.RED
	//   var bbox = getBBox(entity);
	//   var lines = getSectLine(type, bbox);
	//   var polygons = getPolygon(entity);
	//   var polylines = lineInterSect(lines, polygons, color);

	// }

	// 第一步 根据当前对象获取边界多边形
	function getBBox(entity) {
	  var geometrys = entity.plotGeometrys;
	  var startLon, startLat, endLon, endLat;
	  geometrys.map(function (geometry) {
	    var lonlats = cartesinsToLonlats(geometry.positions);
	    if (startLon === undefined) {
	      startLon = lonlats[0][0];
	      startLat = lonlats[0][1];
	      endLon = lonlats[0][0];
	      endLat = lonlats[0][1];
	    }
	    for (var i = 1; i < lonlats.length; i++) {
	      if (startLon < lonlats[i][0]) startLon = lonlats[i][0];
	      if (startLat < lonlats[i][1]) startLat = lonlats[i][1];
	      if (endLon > lonlats[i][0]) endLon = lonlats[i][0];
	      if (endLat > lonlats[i][1]) endLat = lonlats[i][1];
	    }
	  });

	  var bbox = [startLon, startLat, endLon, endLat];
	  return bbox;
	}
	// 第二步 根据类型获取不同的线条数组
	// 类型包括，水平、竖线、斜线、反斜线、普通网格、斜线网格
	function getSectLine(type, bbox) {
	  var num = 37;
	  switch (type) {
	    case "horLine":
	      return HorLine(bbox, num);
	    case "verLine":
	      return VerLine(bbox, num);
	    case "biaLine":
	      return BiaLine1(bbox, num);
	    case "backLine":
	      return BiaLine2(bbox, num);
	    case "gridLine":
	      var line1 = HorLine(bbox, num);
	      var line2 = VerLine(bbox, num);
	      var lines = [];
	      line1.map(function (line) {
	        lines.push(line);
	      });
	      line2.map(function (line) {
	        lines.push(line);
	      });
	      return lines;
	    case "biaGridLine":
	      line1 = BiaLine1(bbox, num);
	      line2 = BiaLine2(bbox, num);
	      lines = [];
	      line1.map(function (line) {
	        lines.push(line);
	      });
	...
	function HorLine(bbox, num) {
	  var lines = [];
	  var delta = (bbox[1] - bbox[3]) / num;

	  for (var i = 1; i < num; i++) {
	    var lat = bbox[3] + delta * i;
	    var line = turf.lineString([[bbox[0], lat], [bbox[2], lat]]);
	...
	function VerLine(bbox, num) {
	  var lines = [];
	  var delta = (bbox[0] - bbox[2]) / num;

	  for (var i = 1; i < num; i++) {
	    var lon = bbox[2] + delta * i;
	    var line = turf.lineString([[lon, bbox[1]], [lon, bbox[3]]]);
	...
	function BiaLine1(bbox, num) {
	  var lines = [];
	  var delta = (bbox[0] - bbox[2]) / num * 2;

	  for (var i = 1; i < num; i++) {
	    var lon1 = bbox[2] + delta * i;
	    var lon2 = bbox[0] - delta * (num - i);
	    var line = turf.lineString([[lon1, bbox[1]], [lon2, bbox[3]]]);
	    lines.push(line);
	  }

	  return lines;
	}
	function BiaLine2(bbox, num) {
	  var lines = [];
	  var delta = (bbox[0] - bbox[2]) / num * 2;
	  for (var i = 1; i < num; i++) {
	    var lon1 = bbox[2] + delta * i;
	    var lon2 = bbox[0] - delta * (num - i);
	    var line = turf.lineString([[lon1, bbox[3]], [lon2, bbox[1]]]);
	...
	function getPolygon(entity) {
	  var geometrys = entity.plotGeometrys;
	  var polygons = [];
	  geometrys.map(function (geometry) {
	    var lonlats = cartesinsToLonlats(geometry.positions);
	    lonlats.push(lonlats[0]);
	    var polygon = turf.polygon([lonlats]);
	...
	function lineInterSect(lines, polygons, color) {
	  var polylines = [];
	  var points = [];
	  polygons.map(function (polygon) {
	    lines.map(function (line) {
	      var intersects = turf.lineIntersect(line, polygon);
	      if (intersects && intersects.features.length % 2 === 0) {
	        var features = sortLonlats(intersects.features);
	        features.map(function (point, index) {
	  ...
	  for (var i = 0; i < points.length; i = i + 2) {
	    polylines.push(new GeoVis.Polyline([points[i], points[i + 1]], {
	      colors: [color],
	      vertexColor: true,
	      followSurface: true,
	      width: 2.0
	  ...
	  var batch = new GeoVis.PolylineBatch(polylines);
	  return batch;
	}
	...
	function sortLonlats(points) {
	  if (points.length < 3) return points;
	  var disAD = turf.distance(points[0], points[3]);
	  var disBD = turf.distance(points[1], points[3]);
	  var disCD = turf.distance(points[2], points[3]);
	  if (disAD < disCD) {
	    if (disAD > disBD) {
	      return [points[3], points[1], points[0], points[2]];
	    } else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MarkerGroup = __webpack_require__(23);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Wall = __webpack_require__(25);

	var _Wall2 = _interopRequireDefault(_Wall);

	var _geometryHelper = __webpack_require__(18);

	var _Animator = __webpack_require__(26);
	...
	var PlotShape = function (_ChangeablePrimitive) {
	  ...
	  function PlotShape(options) {
	    ...
	    _this._isFill = options.fill || false;
	    ...
	    _this._fillLineType = GeoVis.defaultValue(options.fillLineType, "default");
	    _this._fillLineColor = options.fillLineColor || GeoVis.Color.RED;

	    _this._elevationMode = options.elevationMode || "absolute";
	    _this._elevationHeight = options.elevationHeight || undefined;
	    _this.animate = options.animate || false;
	    _this.pickTileset = options.pickTileset || false;
	    return _this;
	  }
	  ...
	  _createClass(PlotShape, [{
	    ...
	    set: function set(value) {
	      ...
	      (0, _material.createFillLine)(this);
	    }
	    /**
	     * 获取PlotShape的线条颜色
	     * @type {Color}
	    ...
	    key: "fillLineType",
	    get: function get() {
	      return this._fillLineType;
	    },
	    set: function set(val) {
	      this._fillLineType = val;
	      this._createPrimitive = true;
	    }
	  }, {
	    key: "fillLineColor",
	    get: function get() {
	      return this._fillLineColor;
	    },
	    set: function set(val) {
	      this._fillLineColor = val;
	      this._createPrimitive = true;
	    }
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.addAnimate = function (options) {
	    var animator = new _Animator2.default(_this3, _extends({}, options));
	    animator.addTo(_this3.drawHelper._sceneInfor.animatorGroup);
	    _this3.animate = true;
	    _this3.drawHelper.fire("addAnimator", {
	      animator: animator
	    });
	  };

	  this.removeAnimate = function () {
	    var animator = _this3.drawHelper._sceneInfor.animatorGroup.getById(_this3.id);
	    if (animator) {
	      _this3.drawHelper.fire("deletedAnimator", {
	        animator: animator
	      });
	      _this3.animate = false;
	      animator.removeFrom(_this3.drawHelper._sceneInfor.animatorGroup);
	    }
	  };
	  ...
	  this.removeFillLine = function () {
	    if (_this3.polylineBatch) {
	      _this3.polylineBatch.removeFrom(_this3.drawHelper.features);
	    }
	  };
	  ...
	  this.deleted = function () {
	    ...
	    _this3.removeAnimate && _this3.removeAnimate();
	    _this3.removeBillboard && _this3.removeBillboard();
	    _this3.removeWall && _this3.removeWall();
	    _this3.removeFillLine && _this3.removeFillLine();
	    _this3.drawHelper._primitives.remove(_this3);

	    _this3.drawHelper._plots.delete(_this3.id);
	    _this3.drawHelper.mouseOutObject = undefined;
	  };
	};
	          ...
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              ...
	              case 2:
	                ...
	                _context2.next = 11;
	                return (0, _websocket.getGeomtry)(this.plot.custom, this.plot.type, this.plot);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.messageHandler = exports.createSocketConnection = exports.createSocketIoConnection = exports.createProtoType = exports.getGeomtry = undefined;
	...
	var createSocketIoConnection = exports.createSocketIoConnection = function () {
	  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee3(host, drawHelper) {
	    return _regenerator2.default.wrap(function _callee3$(_context3) {
	      while (1) {
	        switch (_context3.prev = _context3.next) {
	          case 0:
	            ...
	            socket.on("chat message", function (msg) {
	              msg = JSON.parse(msg);
	              drawHelper.emitEntity(msg, drawHelper, "3d");
	            });
	            return _context3.abrupt("return", socket);
	  ...
	  return function createSocketIoConnection(_x4, _x5) {
	    return _ref3.apply(this, arguments);
	  };
	}();

	var createSocketConnection = exports.createSocketConnection = function () {
	  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee4(host) {
	    return _regenerator2.default.wrap(function _callee4$(_context4) {
	      while (1) {
	        switch (_context4.prev = _context4.next) {
	          case 0:
	            ws = new WebSocket("ws://localhost:8003/websocket/test");
	            ...
	            return _context4.abrupt("return", ws);
	  ...
	  return function createSocketConnection(_x6) {
	    return _ref4.apply(this, arguments);
	  };
	}();

	var _PlotGeometry = __webpack_require__(29);
	...
	var messageHandler = exports.messageHandler = function () {
	  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee5(evt) {
	      ...
	      while (1) {
	        switch (_context5.prev = _context5.next) {
	          ...
	          case 12:
	            ...
	            buf = new _context5.t0(_context5.t1);
	  ...
	  return function messageHandler(_x7) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Polygon2 = __webpack_require__(16);
	...
	var Classify = function (_Polygon) {
	  _inherits(Classify, _Polygon);

	  function Classify(options) {
	    _classCallCheck(this, Classify);

	    var _this = _possibleConstructorReturn(this, (Classify.__proto__ || Object.getPrototypeOf(Classify)).call(this, options));

	    _this.material = GeoVis.Material.fromType(GeoVis.Material.ColorType);
	    _this.material.uniforms.color = options.fillColor || GeoVis.Color.fromCssString("#009688").withAlpha(0.3);
	    _this.type = options.type || _Types2.default.CLASSIFY_POLYGON;
	    _this.name = options.name || "单体化";
	    _this.drawHelper = options.drawHelper;
	    _this._height = options.height || 0;
	    _this._extrudedHeight = options.extrudedHeight || 0;
	    _this.appearance = new GeoVis.MaterialAppearance({
	      flat: true,
	      material: _this.material
	    });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pickPosition = __webpack_require__(38);
...
/***/ (function(module, exports) {
	...
	exports.autoPickPosition = autoPickPosition;
	...
	function autoPickPosition(scene, event, options) {
	  var pickObj = event.pickedObj;
	  var cartesian;
	  if (pickObj && pickObj instanceof GeoVis.Cesium3DTileset) {
	    cartesian = getPosition(scene, {
	      x: event.windowPosition[0],
	      y: event.windowPosition[1]
	    });
	    options.pickTileset = true;
	  } else {
	    cartesian = event.position;
	    options.pickTileset = false;
	  }
	  return cartesian;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _TextMarker = __webpack_require__(40);

	var _TextMarker2 = _interopRequireDefault(_TextMarker);

	var _TextMarkerNew = __webpack_require__(45);

	var _TextMarkerNew2 = _interopRequireDefault(_TextMarkerNew);

	var _ImageMarker = __webpack_require__(46);
	...
	function unserializeText(options, drawHelper, mode) {
	  ...
	  if (options.type === _Types2.default.TEXT_MARKER) {
	    marker = new _TextMarker2.default(position, _extends({}, options, { drawHelper: drawHelper }));
	  } else {
	    marker = new _TextMarkerNew2.default(position, _extends({}, options, { drawHelper: drawHelper }));
	  }

	  if (mode === "3d") {
	    marker.addTo(drawHelper.features);
	    marker.setEditable && marker.setEditable();
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _interactjs = __webpack_require__(44);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pickr = __webpack_require__(43);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TextMarker = function (_GeoVis$DomMarker) {
	  ...
	  function TextMarker(pos, options) {
	    ...
	    _this.type = options.type || _Types2.default.TEXT_MARKER_NEW;
	    _this._element.className = "geo-resizer";
	    _this.drawHelper = options.drawHelper;
	    _this.textEle = textEle;
	  ...
	  _createClass(TextMarker, [{
	    ...
	    key: "align",
	    get: function get() {
	      return this.textEle.style.textAlign;
	    },
	    set: function set(val) {
	      this.textEle.style.textAlign = val;
	    }
	  }, {
	    key: "color",
	    get: function get() {
	      return this.textEle.style.color;
	    },
	    set: function set(color) {
	      this.textEle.style.color = color;
	    }
	  }, {
	    key: "backgroundColor",
	    get: function get() {
	      return this.textEle.style.backgroundColor;
	    },
	    set: function set(colorStr) {
	      this.textEle.style.backgroundColor = colorStr;
	    }
	  }, {
	    key: "fontFamily",
	    get: function get() {
	      return this.textEle.style.fontFamily;
	    },
	    set: function set(val) {
	      this.textEle.style.fontFamily = val;
	    }
	  }, {
	    key: "weight",
	    get: function get() {
	    ...
	    set: function set(val) {
	      this._weight = val;
	      if (val) {
	        this.textEle.style.fontWeight = "700";
	      } else {
	        this.textEle.style.fontWeight = "500";
	      }
	    }
	  }, {
	    key: "fontSize",
	    get: function get() {
	      return this.textEle.style.fontSize;
	    },
	    set: function set(val) {
	      this.textEle.style.fontSize = val;
	    }
	  }, {
	    key: "italic",
	    get: function get() {
	    ...
	    set: function set(val) {
	      this._italic = val;
	      if (val) {
	        this.textEle.style.fontStyle = "italic";
	      } else {
	        this.textEle.style.fontStyle = "normal";
	      }
	    }
	  }, {
	    key: "width",
	    ...
	    set: function set(val) {
	      this.textEle.style.borderStyle = val;
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.deleted = function () {
	    ...
	    _this2.removeAnimate();
	    if (_this2.label) {
	      _this2.label.removeFrom(_this2.drawHelper.features);
	    }
	    _this2.drawHelper.features.remove(_this2);
	    _this2.drawHelper._plots.delete(_this2.id);
	    _this2.drawHelper.mouseOutObject = undefined;
	  ...
	  this.addAnimate = function (options) {
	    var animator = new _Animator2.default(_this2, _extends({}, options));
	    _this2.animate = true;
	    animator.addTo(_this2.drawHelper._sceneInfor.animatorGroup);
	    _this2.drawHelper.fire("addAnimator", {
	      animator: animator
	    });
	  };

	  this.removeAnimate = function () {
	    var animator = _this2.drawHelper._sceneInfor.animatorGroup.getById(_this2.id);
	    if (animator) {
	      _this2.drawHelper.fire("deletedAnimator", { animator: animator });
	      _this2.animate = false;
	      animator.removeFrom(_this2.drawHelper._sceneInfor.animatorGroup);
	    }
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function serializeScene(scene) {
	  ...
	  var animators = [];
	  scene.animatorGroup.map.forEach(function (animator) {
	    animators.push({
	      id: animator.id,
	...
	function unserializeScene(options, drawHelper) {
	  ...
	  options.animators && options.animators.map(function (animator) {
	    drawHelper.primitives._primitives.map(function (entity) {
	      if (!entity.type) return;
	      if (entity.id === animator.id) {
	        //如果此对象有动画，则判断动画效果是否一致，进行修改
	        console.log("存在");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _AnimatorGroup = __webpack_require__(51);

	var _AnimatorGroup2 = _interopRequireDefault(_AnimatorGroup);
	...
	var Scene = function () {
	  ...
	  function Scene(options) {
	    ...
	    this.animatorGroup = new _AnimatorGroup2.default();
	  }
...
/***/ (function(module, exports) {
	...
	var AnimatorGroup = function () {
	  ...
	  function AnimatorGroup() {
	    ...
	    _classCallCheck(this, AnimatorGroup);

	    this.update = function () {
	      // debugger
	      _this.map.forEach(function (animator) {
	        if (animator.hierarchy === _this.hierarchy && animator.visible) {
	          animator.update(true);
	        } else if (animator.hierarchy < _this.hierarchy && animator.visible) {
	          // animator.update(false);
	        } else {
	          animator.plot.visible = false;
	        }
	      });
	    };

	    this.getById = function (id) {
	      var animator = _this.map.get(id);
	      return animator;
	    };
	  ...
	  _createClass(AnimatorGroup, [{
	     ...
	     */
	    value: function add(animator) {
	      if (this.map.get(animator.id)) {
	        console.error("animator id 重复");
	      } else {
	        this.map.set(animator.id, animator);
	      }
	    }
	    /**
	     * 移除动画对象
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _GroundText = __webpack_require__(53);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GroundText = function () {
	  function GroundText(options) {
	    ...
	    this._color = options.color || GeoVis.Color.WHITE;
	    this._outlineColor = options.outlineColor || GeoVis.Color.BLACK;
	  ...
	  _createClass(GroundText, [{
	    ...
	    value: function () {
	      var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
	        var fontSize, padding, color, outlineColor, outlineWidth, text, fontFamily, textDirection, newColor, newOutlineColor, options, canvas;
	        return _regenerator2.default.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                ...
	                if (Object.prototype.toString.call(color) === '[object String]') {
	                  newColor = new GeoVis.Color.fromCssColorString(color);
	                } else {
	                  newColor = color;
	                }

	                if (Object.prototype.toString.call(outlineColor) === '[object String]') {
	                  newOutlineColor = new GeoVis.Color.fromCssColorString(outlineColor);
	                } else {
	                  newOutlineColor = outlineColor;
	                }
	                options = {
	                  ...
	                  stroke: true,
	                  fillColor: newColor,
	                  strokeColor: newOutlineColor,
	                  strokeWidth: outlineWidth,
	                  backgroundColor: GeoVis.Color.TRANSPARENT,
	                  padding: 0
	                };
	                canvas = GeoVis.writeTextToCanvas(text, options);
	                // canvas.width=40;
	                // canvas.height=17
...
/***/ (function(module, exports, __webpack_require__) {
	...
	PointGroup.prototype.createPoint = function (position, callbacks, heightReference) {
	  ...
	  point.pickTileset = this._options.pickTileset || false;
	    ...
	    if (callbacks.dragHandlers) {
	      ...
	      (0, _util.setListener)(point, "leftDown", function (position) {
	        ...
	        function onMouseMove(event) {
	          ...
	          var cartesian = (0, _pickPosition2.default)(_self._scene, event, point.pickTileset);
	          if (cartesian) {
	            onDrag(cartesian);
	          } else {
	            onDragEnd(cartesian);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _export = __webpack_require__(63);
	...
	var Main = function () {
	  function Main(viewer, options) {
	    ...
	    // this._multSelect = new Plot.MultSelete(this);
	    this.dragging = false;
	  }
	  ...
	  _createClass(Main, [{
	    ...
	    value: function resetScene(options) {
	      this._sceneInfor.update(options);
	    }
	    /**
	     * 清除所有图形和监听
	     */
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.startDrawingArea = Plot.startDrawingArea;
	  this.startDrawingDragMarker = Plot.startDrawingDragMarker;
	  this.startDrawingGroundText = Plot.startDrawingGroundText;
	  this.startDrawingModel = Plot.startDrawingModel;
	  this.emitEntity = Plot.emitEntity;
	...
	Main.TextMarkerNew = Plot.TextMarkerNew;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _compute = __webpack_require__(66);
	...
	var _serialize = __webpack_require__(13);
	...
	Object.defineProperty(exports, "emitEntity", {
	  enumerable: true,
	  get: function get() {
	    return _serialize.emitEntity;
	  }
	});
	...
	var _serialize2 = __webpack_require__(68);
	...
	var _PointGroup = __webpack_require__(54);
	...
	var _PrimitiveCollection = __webpack_require__(71);
	...
	var _MeasureTool = __webpack_require__(86);
	...
	var _PlotCopy = __webpack_require__(87);
	...
	var _MultSelete = __webpack_require__(88);

	Object.defineProperty(exports, "MultSelete", {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_MultSelete).default;
	  }
	});
	...
	Object.defineProperty(exports, "ClassifyPrimitive", {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_Classify).default;
	  }
	});
	...
	Object.defineProperty(exports, "TextMarkerNew", {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_TextMarkerNew).default;
	  }
	});
	...
	var _startDrawingCircle = __webpack_require__(89);
	...
	var _startDrawingPolygon = __webpack_require__(90);
	...
	Object.defineProperty(exports, "startDrawingArea", {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_startDrawingArea).default;
	  }
	});
	...
	Object.defineProperty(exports, "startDrawingModel", {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_startDrawingModel).default;
	  }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _geographiclib = __webpack_require__(67);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _extra = __webpack_require__(69);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _IconEditor = __webpack_require__(73);

	var _IconEditor2 = _interopRequireDefault(_IconEditor);

	var _CircleEditor = __webpack_require__(74);

	var _CircleEditor2 = _interopRequireDefault(_CircleEditor);

	var _PlotEditor = __webpack_require__(75);

	var _PlotEditor2 = _interopRequireDefault(_PlotEditor);

	var _PolyLineEditor = __webpack_require__(76);

	var _PolyLineEditor2 = _interopRequireDefault(_PolyLineEditor);

	var _PolygonEditor = __webpack_require__(77);

	var _PolygonEditor2 = _interopRequireDefault(_PolygonEditor);

	var _RectangleEditor = __webpack_require__(78);

	var _RectangleEditor2 = _interopRequireDefault(_RectangleEditor);

	var _WallEditor = __webpack_require__(79);

	var _WallEditor2 = _interopRequireDefault(_WallEditor);

	var _MarkerEditor = __webpack_require__(80);

	var _MarkerEditor2 = _interopRequireDefault(_MarkerEditor);

	var _GroundTextEditor = __webpack_require__(81);

	var _GroundTextEditor2 = _interopRequireDefault(_GroundTextEditor);

	var _TextMarkerEditor = __webpack_require__(82);

	var _TextMarkerEditor2 = _interopRequireDefault(_TextMarkerEditor);

	var _ModelEditor = __webpack_require__(83);

	var _ModelEditor2 = _interopRequireDefault(_ModelEditor);
	...
	var Editor = function () {
	  function Editor(drawHelper) {
	    ...
	    this.editableEvent = function (surface) {
	      ...
	      (0, _util.setListener)(surface, "leftDoubleClick", function () {
	        if (!_self.drawHelper.primitives.contains(surface)) return;
	        surface.deleted && surface.deleted();
	        // _editor.setEditable(surface, false);
	        // _editor.setHighlighted(surface, false);
	        // _self.drawHelper._tooltip.setVisible(false);

	        // surface.removeBillboard && surface.removeBillboard();
	        // surface.removeWall && surface.removeWall();
	        // surface.removeFillLine && surface.removeFillLine();

	        // _self.drawHelper._primitives.remove(surface);
	        // _self.drawHelper._plots.delete(surface.id)
	    ...
	    this.getEditor = function (entity) {
	      switch (entity.type) {
	        case _Types2.default.MODEL:
	          if (!_this._modelEditor) {
	            _this._modelEditor = new _ModelEditor2.default(_this.drawHelper);
	          }
	          return _this._modelEditor;
	        case _Types2.default.ICON:
	        ...
	        case _Types2.default.TEXT_MARKER_NEW:
	          if (!_this._textMarkerEditor) _this._textMarkerEditor = new _TextMarkerEditor2.default(_this.drawHelper);
	          return _this._textMarkerEditor;
	        case _Types2.default.GROUND_TEXT:
	    ...
	    this.setEditable = function (entity, visible) {
	      var _editor = _this.getEditor(entity);
	      _editor.setEditable(entity, visible);
	      _editor.setHighlighted(entity, visible);
	    };
	  ...
	  _createClass(Editor, [{
	    ...
	    value: function removeAll() {
	      ...
	      if (this._modelEditor) this._modelEditor.map = new Map();
	    }
	  }]);
	  ...
	  function IconEditor(drawhelper) {
	    ...
	    this.addListeners = function (icon) {
	      ...
	      if (icon._point == null) {
	        ...
	        _config.dragPoint.pickTileset = icon.pickTileset;
	  ...
	  function PlotEditor(drawhelper) {
	    ...
	    this.addListeners = function (entity) {
	      ...
	      if (entity._points == null) {
	        // var points = _self.drawHelper.points;
	        _config.dragPoint.pickTileset = entity.pickTileset;
	        var points = new _PointGroup2.default(_self.drawHelper, _config.dragPoint);
	        _self.drawHelper.removeObj.billBoard.push(points);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MarkerEditor = function () {
	  function MarkerEditor(drawhelper) {
	    ...
	    this.add = function (entity) {
	      if (_this.map.get(entity.id)) {} else {
	        _this.map.set(entity.id, entity);
	        _this.editableEvent();
	      }
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TextMarkerEditor = function () {
	  function TextMarkerEditor(drawhelper) {
	    var _this = this;

	    _classCallCheck(this, TextMarkerEditor);
	    ...
	    this.addListeners = function (marker) {
	      ...
	      _this.enableResize(marker);
	      marker.textEle.disabled = false;
	      marker.textEle.focus();
	      (0, _util.removeClass)(marker.textEle, "geo-dragble");
	      marker._editMode = true;
	  ...
	  _createClass(TextMarkerEditor, [{
	    key: "enableResize",
	    value: function enableResize(marker) {
	      (0, _util.addClass)(marker.element, "geo-resizeble");
	    }
	  }, {
	    key: "disableResize",
	    value: function disableResize(marker) {
	      (0, _util.removeClass)(marker.element, "geo-resizeble");
	    }
	    /**
	     * 添加Marker的编辑控制点及监听
	     * @param {Marker} marker
	    ...
	    value: function removeListners(marker) {
	      marker.textEle.blur();
	      marker.textEle.disabled = true;
	      (0, _util.addClass)(marker.textEle, "geo-dragble");
	    ...
	    key: "resize",
	    value: function resize(editMode) {
	      if (editMode) {
	  ...
	  return TextMarkerEditor;
	}();

	exports.default = TextMarkerEditor;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Editor3D = __webpack_require__(85);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

	var entityEditor = function () {
	  function entityEditor(drawhelper) {
	    var _this = this;
	    ...
	    this.editableEvent = function (entity) {
	      ...
	      (0, _util.setListener)(entity, "mouseMove", function (position) {
	        if (!entity._editMode) {
	          entity._tooltip.showAt(position, "点击以编辑图标");
	        }
	      });
	    };
	    ...
	    this.addListeners = function (entity) {
	      ...
	      _self.drawHelper._editor.setEdited(entity);
	      _self.drawHelper._editor.setHighlighted(entity);
	      if (entity._point == null) {
	        _config.dragPoint.scale = entity._markerScale;
	        var point = new _PointGroup2.default(_self.drawHelper, _config.dragPoint);
	        _self.drawHelper.removeObj.billBoard.push(point);
	        var handleMarkerChanges = {
	          dragHandlers: {
	        ...
	        point.addPoint(entity.position, handleMarkerChanges);
	        entity._point = point;
	        ...
	        _this.editorModel = new _Editor3D.Editor3D(options).addTo(earth);
	      ...
	      // if (entity._marker == null && entity.elevationMode !== "clampToGround") {
	      //   entity._marker = addTranMarker(_self.drawHelper, entity);
	      //   entity._marker.getMarker(0).pixelOffset = new GeoVis.Cartesian2(-40, 0);
	      //   entity._highMarker = addHighMarker(_self.drawHelper, entity);
	      // }
	    ...
	    this.removeListners = function (entity) {
	      if (entity._point != null) {
	        entity._point.remove();
	        entity._point = null;
	      }
	      if (entity._marker) {
	        entity._marker.remove();
	      ...
	      if (_this.editorModel) {
	        _this.editorModel.removeFrom(_this.drawHelper._earth);
	        _this.editorModel = undefined;
	      }
	      entity._editMode = false;
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Model = function () {
	  function Model(pos, options) {
	    ...
	    this.drawHelper = options.drawHelper;
	    this._id = options.id || GeoVis.createGuid();
	    this._lonlat = (0, _util.cartesianToLonlat)(pos);
	    this._position = pos;
	    this.type = options.type;
	    this.url = options.url;
	    this.image = options.image || undefined;
	    this._scale = options.scale || 1;
	    this._maximumScale = options.maximumScale || 1;
	    this._imageScale = options.imageScale || 1;
	    this._tooltip = this.drawHelper._tooltip;
	    this._visible = options.visible || true;
	    this.show = options.show || true;
	    this.name = options.name || null;
	    var modelMatrix = (0, _util.computeModelMatrix)(this._position);
	    this._markerScale = options.markerScale || 1.0;
	    this.highLightColor = GeoVis.defaultValue(options.color, GeoVis.Color.RED);
	    ...
	    this._model = GeoVis.Model.fromGltf({
	      ...
	      scale: options.scale,
	      minimumPixelSize: 96,
	      maximumScale: 60, // options.maximumScale,
	      allowPicking: true,
	      debugShowBoundingVolume: false,
	      distanceDisplayCondition: new GeoVis.DistanceDisplayCondition(0, 4e5),
	      debugWireframe: false
	    });
	    this._billboard = new GeoVis.Billboard(pos, {
	      id: this,
	      image: options.image,
	      show: options.show,
	      width: 40,
	      height: 40,
	      distanceDisplayCondition: new GeoVis.DistanceDisplayCondition(4e5),
	  ...
	  _createClass(Model, [{
	    key: "addTo",
	    value: function addTo(features) {
	      if (features.map.get(this.id)) {
	        console.error("Features id 重复");
	      }
	      features.map.set(this.id, this);
	      this._model.addTo(features);
	      this._billboard.addTo(features);
	      return this;
	    }
	    /**
	     * 移除点标
	    ...
	    value: function removeFrom(features) {
	      ...
	      this._model.removeFrom(features);
	      this._billboard.removeFrom(features);
	      features.map.delete(this.id);
	      this._marker && this._marker.removeFrom(features);
	      this._features = undefined;
	      return this;
	    ...
	    set: function set(val) {
	      this._scale = val;
	      this._model.scale = val;
	      this._billboard.scale = val / 40;
	    }
	  }, {
	    key: "position",
	    get: function get() {
	    ...
	    set: function set(val) {
	      this._position = val;
	      this._model.modelMatrix = (0, _util.computeModelMatrix)(val);
	      this._billboard.position = val;
	    }
	  }]);
...
/***/ (function(module, exports) {
	...
	function pickOperation(earth, event) {
	  var operations = ["xoy", "yoz", "xoz", "move", "up", "down"]; // 所有操作
	  var pick = event.pickedObj;
	  if (pick && operations.indexOf(pick.id) !== -1) {
	    return pick.id;
	  } else {
	    return false;
	  }
	...
	// 2D移动 平面移动
	function updateModelByDistance(position, start, end, matrixOrigin) {
	  GeoVis.Cartesian3.add(GeoVis.Cartesian3.negate(start, start), end, end);
	  GeoVis.Cartesian3.add(end, position, position);
	  var matrix = GeoVis.Transforms.eastNorthUpToFixedFrame(position);
	  var result = new GeoVis.Cartesian4();
	  GeoVis.Matrix4.getColumn(matrix, 3, result); // 平移
	  GeoVis.Matrix4.setColumn(matrixOrigin, 3, result, matrixOrigin);
	  return matrixOrigin;
	}
	...
	function computeAngle(center, startPosition, endPosition) {
	  var angle;
	  // 屏幕上判断顺逆时针
	  var a = Math.sqrt(Math.pow(endPosition.y - center.y, 2) + Math.pow(endPosition.x - center.x, 2));
	  var b = Math.sqrt(Math.pow(startPosition.y - center.y, 2) + Math.pow(startPosition.x - center.x, 2));
	  var c = Math.sqrt(Math.pow(endPosition.y - startPosition.y, 2) + Math.pow(endPosition.x - startPosition.x, 2));
	  var cos = (a * a + b * b - c * c) / (2 * a * b);
	  angle = Math.acos(cos) * 180 / Math.PI;
	  var direct = (startPosition.x - center.x) * (endPosition.y - center.y) - (startPosition.y - center.y) * (endPosition.x - center.x);
	  // 向量的叉乘判断方向
	  if (direct > 0) {
	    angle = -angle;
	  }
	...
	function calculateDirect(axis, cartesian3, deflex, matrix) {
	  var result = new GeoVis.Cartesian4();
	  var axisVector = new GeoVis.Cartesian3();
	  var angle;
	  switch (axis) {
	    case "x":
	      GeoVis.Matrix4.getColumn(matrix, 0, result);
	      axisVector = GeoVis.Cartesian3.fromCartesian4(result);
	      angle = GeoVis.Cartesian3.angleBetween(cartesian3, axisVector);
	      break;
	    case "y":
	      GeoVis.Matrix4.getColumn(matrix, 1, result);
	      axisVector = GeoVis.Cartesian3.fromCartesian4(result);
	      angle = GeoVis.Cartesian3.angleBetween(cartesian3, axisVector);
	      break;
	    case "z":
	      GeoVis.Matrix4.getColumn(matrix, 2, result);
	      axisVector = GeoVis.Cartesian3.fromCartesian4(result);
	      angle = GeoVis.Cartesian3.angleBetween(cartesian3, axisVector);
	      break;
	  }
	  if (GeoVis.Math.toDegrees(angle) > 90) {
	    // 角度>90，表示为在负轴，角度取反，----表示顺逆时针取反
	    deflex = -deflex;
	  }
	  return deflex;
	}
	...
	function getPosition(matrix4) {
	  var matrix = matrix4;
	  var result = new GeoVis.Cartesian4();
	  GeoVis.Matrix4.getColumn(matrix, 3, result);
	  var position = new GeoVis.Cartesian3(result.x, result.y, result.z);
	  return position;
	}

	function updateModelByAngle(pickId, center, position, startWindowPosition, endWindowPosition, cameraPosition, matrix) {
	  var angle = computeAngle(center, startWindowPosition, endWindowPosition);
	  GeoVis.Cartesian3.negate(position, position); // 得到视角点
	  var direct = new GeoVis.Cartesian3();
	  GeoVis.Cartesian3.add(position, cameraPosition, direct);
	  switch (pickId) {
	    case "yoz":
	      // y o z平面 GREEN north
	      angle = calculateDirect("x", direct, angle, matrix);
	      var rotationX = GeoVis.Matrix4.fromRotationTranslation(GeoVis.Matrix3.fromRotationX(GeoVis.Math.toRadians(angle)));
	      GeoVis.Matrix4.multiply(matrix, rotationX, matrix);
	      break;
	    case "xoy":
	      // x o y  BLUE
	      angle = calculateDirect("z", direct, angle, matrix);
	      var rotationZ = GeoVis.Matrix4.fromRotationTranslation(GeoVis.Matrix3.fromRotationZ(GeoVis.Math.toRadians(angle)));
	      GeoVis.Matrix4.multiply(matrix, rotationZ, matrix);
	      break;
	    case "xoz":
	      // x o z  RED east
	      angle = calculateDirect("y", direct, angle, matrix);
	      var rotationY = GeoVis.Matrix4.fromRotationTranslation(GeoVis.Matrix3.fromRotationY(GeoVis.Math.toRadians(angle)));
	      GeoVis.Matrix4.multiply(matrix, rotationY, matrix);
	      break;
	  }
	  return matrix;
	}
	function updateModelByHeight(position, startPosition, endPosition, positionLongLat, scale, matrixOrigin) {
	  var direct = endPosition.y - startPosition.y;
	  if (endPosition.y - startPosition.y === 0) {
	    ...
	    var longitude = GeoVis.Math.toDegrees(positionLongLat.longitude);
	    var latitude = GeoVis.Math.toDegrees(positionLongLat.latitude);
	    height += positionLongLat.height;
	    position = new GeoVis.Cartesian3.fromDegrees(longitude, latitude, height);
	    var matrix = GeoVis.Transforms.eastNorthUpToFixedFrame(position);
	    var result = new GeoVis.Cartesian4();
	    GeoVis.Matrix4.getColumn(matrix, 3, result); // 平移
	    GeoVis.Matrix4.setColumn(matrixOrigin, 3, result, matrixOrigin);
	...
	function Editor3D(options) {
	  var earth = options.earth,
	  ...
	  // this.clock = clock;
	  this.system = createCoordinateSystem(earth, modelMatrix, scale);
	...
	Editor3D.prototype.initEvents = function () {
	  var earth = this.earth;
	  earth.on("mouseMove", this.handleMouseMove);
	  earth.on("click", this.handleClick);
	  earth.on("leftUp", this.clickUp);
	  earth.on("leftDown", this.clickDown);
	};
	Editor3D.prototype.bindEntity = function (entity) {
	  var modelMatrix = entity.modelMatrix;
	  var scale = entity.scale;
	  if (this.scale !== scale) {
	    this.removeSystem(this.system);
	    this.system = createCoordinateSystem(this.earth, modelMatrix, scale);
	    this.scale = scale;
	  }
	  this.updateMatrixSystem(modelMatrix);
	  this.modelMatrix = modelMatrix;
	  this.entity = entity;
	};
	// Editor3D.prototype.update = function() {
	// if (!this.clock.shouldAnimate) {
	//     if (this.trackedEntity.entity.modelMatrix !== this.modelMatrix) {
	//         var modelMatrix = this.trackedEntity.entity.modelMatrix;
	//         this.updateMatrixSystem(modelMatrix);
	//         this.modelMatrix = modelMatrix;
	//     }
	// } else {
	...
	// }
	// }
	Editor3D.prototype.removeEvents = function () {
	  this.earth.off("mouseMove", this.handleMouseMove);
	  this.earth.off("click", this.handleClick);
	  this.earth.off("leftUp", this.clickUp);
	  this.earth.off("leftDown", this.clickDown);
	};

	Editor3D.prototype.removeSystem = function (system) {
	  var earth = this.earth;
	  system.forEach(function (item) {
	    earth.scene.primitives.remove(item);
	  });
	};
	Editor3D.prototype.handleMouseMove = function (e) {
	  var earth = this.earth;
	  var operations = ["xoy", "yoz", "xoz", "move", "up", "down"]; // 所有操作
	  var pickId = this.option;
	  var modelMatrix = this.modelMatrix;
	  var scale = this.scale;
	  if (this.option !== "none") {
	    if (this.mouseMove) {
	      var position = getPosition(modelMatrix);
	      var startWindowPosition = arrayToMap(this.mouseMove);
	      var endWindowPosition = arrayToMap(e.windowPosition);
	      if (operations.indexOf(pickId) === 3) {
	        var start = earth.scene.globe.pick(this.earth.camera.getPickRay(startWindowPosition), this.earth.scene);
	        var end = earth.scene.globe.pick(this.earth.camera.getPickRay(endWindowPosition), this.earth.scene);
	        modelMatrix = updateModelByDistance(position, start, end, modelMatrix);
	      } else if (operations.indexOf(pickId) < 3 && operations.indexOf(pickId) > -1) {
	        var cameraPosition = earth.camera.position;
	        // var center = GeoVis.SceneTransforms.wgs84ToWindowCoordinates(earth.scene, position);
	        var center = earth.scene.cartesianToCanvasCoordinates(position); // 世界坐标转为屏幕坐标
	        modelMatrix = updateModelByAngle(pickId, center, position, startWindowPosition, endWindowPosition, cameraPosition, modelMatrix);
	      } else if (operations.indexOf(pickId) > 3 && operations.indexOf(pickId) < 6) {
	        var positionLongLat = earth.scene.globe.ellipsoid.cartesianToCartographic(position);
	        modelMatrix = updateModelByHeight(position, startWindowPosition, endWindowPosition, positionLongLat, scale, modelMatrix);
	      }
	    }
	    this.mouseMove = e.windowPosition;
	    this.modelMatrix = modelMatrix;
	...
	Editor3D.prototype.handleClick = function (e) {
	  var earth = this.earth;
	  if (pickModel(earth, e)) {
	    var model = pickModel(earth, e);
	    if (model.id === this.entity.id) {
	      this.displaySystem(this.system, this.show);
	    } else {
	      this.bindEntity(model);
	    }
	  }
	};
	Editor3D.prototype.clickDown = function (e) {
	  var earth = this.earth;
	  if (pickOperation(earth, e)) {
	    // 是否为有效操作
	    this.option = pickOperation(earth, e);
	    earth.scene.screenSpaceCameraController.enableRotate = false; // 禁止地图事件
	  } else if (pickModel(earth, e)) {
	    var model = pickModel(earth, e);
	    if (model.id === this.entity.id && this.show) {
	      this.option = "move";
	      earth.scene.screenSpaceCameraController.enableRotate = false; // 禁止地图事件
	    }
	  }
	};
	Editor3D.prototype.clickUp = function (e) {
	  this.earth.scene.screenSpaceCameraController.enableRotate = true; // 地图移动事件
	  this.option = "none";
	  this.mouseMove = undefined;
	};

	Editor3D.prototype.addTo = function (earth) {
	  this.earth = earth;
	  this.initEvents();
	  //   this.earth.on('tick', this.update);
	  return this;
	};
	Editor3D.prototype.removeFrom = function (earth) {
	  this.removeSystem(this.system);
	  this.removeEvents();
	};
	Editor3D.prototype.displaySystem = function (display) {
	  this.system.map(function (primitive) {
	    primitive.show = display;
	  });
	  this.show = display;
	};
	Editor3D.prototype.updateMatrixSystem = function (modelMatrix) {
	  this.system.map(function (primitive) {
	    primitive.modelMatrix = modelMatrix;
	  });
	};

	function createCoordinateSystem(earth, modelMatrix, scale) {
	  var primitives = [];
	  var length = scale * 10;
	  var radius = scale * 12;
	  var xyz = createXyz(modelMatrix, length);
	  var instances = [];
	  instances.push(createBoundingCircle(radius, GeoVis.Color.RED, ["x", 0, "y"], "xoz"));
	  instances.push(createBoundingCircle(radius, GeoVis.Color.BLUE, ["x", "y", 0], "xoy"));
	  instances.push(createBoundingCircle(radius, GeoVis.Color.GREEN, [0, "x", "y"], "yoz"));
	  var circle = new GeoVis.Primitive({
	    geometryInstances: instances,
	    modelMatrix: modelMatrix,
	  ...
	  earth.scene.primitives.add(circle);
	  primitives.push(circle);
	  for (var i = 0; i < 6; i++) {
	    earth.scene.primitives.add(xyz[i]);
	    primitives.push(xyz[i]);
	  }
	  return primitives;
	}
	// 创建xyz坐标轴
	function createXyz(modelMatrix, length) {
	  var height = 1;
	  var xyz = [[0, length, height], // y
	  [0, -length, height], [length, 0, height], // x
	  [-length, 0, height], [0, 0, length], // z
	  [0, 0, -length]];
	  var color = [GeoVis.Color.GREEN, GeoVis.Color.RED, GeoVis.Color.BLUE];
	  var start = new GeoVis.Cartesian3(0, 0, height);
	  var params = ["x", "-x", "y", "-y", "up", "down"];
	  var systemXyzs = [];
	  for (var i = 0; i < 6; i++) {
	    var positions = new Array();
	    var end = GeoVis.Cartesian3.fromArray(xyz[i]);
	    positions.push(start, end);
	    var polyline = new GeoVis.PolylineGeometry({
	      positions: positions,
	      width: 12,
	      arcType: GeoVis.ArcType.NONE,
	      ellipsoid: GeoVis.Ellipsoid.UNIT_SPHERE,
	      vertexFormat: GeoVis.PolylineMaterialAppearance.VERTEX_FORMAT
	    });
	    var instance = new GeoVis.GeometryInstance({
	      geometry: polyline,
	      id: { id: params[i] }
	    });
	    var systemXyz = new GeoVis.Primitive({
	      geometryInstances: instance,
	      modelMatrix: modelMatrix,
	      appearance: new GeoVis.PolylineMaterialAppearance({
	        translucent: false,
	        material: GeoVis.Material.fromType("PolylineArrow", {
	          color: color[Math.floor(i / 2)]
	        })
	      })
	    });
	    systemXyzs.push(systemXyz);
	  }
	  return systemXyzs;
	}
	// 生成圆
	function computeCircle(radius) {
	  var positions = [];
	  for (var i = 0; i < 360; i++) {
	    var radians = GeoVis.Math.toRadians(i);
	    positions.push(new GeoVis.Cartesian2(radius * Math.cos(radians), radius * Math.sin(radians)));
	  }
	  return positions;
	}
	// 创建圆环
	function createBoundingCircle(radius, color, params, id) {
	  var polylinePositions = computeCircle(radius).map(function (vec2) {
	    return new GeoVis.Cartesian3(vec2[params[0]], vec2[params[1]], vec2[params[2]]);
	  });
	  var shapePositions = computeCircle(radius);
	  var polyline = new GeoVis.PolylineVolumeGeometry({
	    polylinePositions: polylinePositions,
	    shapePositions: shapePositions,
	    vertexFormat: GeoVis.PerInstanceColorAppearance.VertexFormat,
	    ellipsoid: GeoVis.Ellipsoid.UNIT_SPHERE
	  });
	  var instance = new GeoVis.GeometryInstance({
	    geometry: polyline,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.inRangeEntity = inRangeEntity;
	...
	var MultSelete = function MultSelete(drawHelper) {
	  var _this = this;

	  _classCallCheck(this, MultSelete);

	  this.drawArea = function () {
	    // this.drawHelper.startDrawingArea({});
	    if (!_this.visible) {
	      //   debugger;
	      _this.visible = true;
	      _this.drawHelper.startDrawingArea({});
	    }
	  };

	  this.multSetEdited = function (entity) {
	    var lonlats = [(0, _util.cartesianToLonlatNoHeight)(entity.positions[0]), (0, _util.cartesianToLonlatNoHeight)(entity.positions[1])];

	    var lon0, lon1, lat0, lat1;
	    if (lonlats[0][0] < lonlats[1][0]) {
	      lon0 = lonlats[0][0];
	      lon1 = lonlats[1][0];
	    } else {
	      lon0 = lonlats[1][0];
	    ...
	    var interval = [lon0, lon1, lat0, lat1];

	    var results = [];
	    _this.drawHelper.primitives._primitives.map(function (entity) {
	      if (!entity.type) return;
	      if (inRangeEntity(interval, entity)) {
	        results.push(inRangeEntity(interval, entity));
	      }
	    });
	    _this.drawHelper.features.markers._markerMap.forEach(function (marker) {
	      if (!marker.type) return;
	      if (inRangeEntity(interval, marker)) {
	        results.push(inRangeEntity(interval, marker));
	      }
	    });
	    _this.drawHelper.features.map.forEach(function (entity) {
	      if (!entity.type) return;
	      if (inRangeEntity(interval, entity)) {
	        results.push(inRangeEntity(interval, entity));
	      }
	    });
	    _this.drawHelper.fire("multSeleted", {
	      entities: results
	    });
	  };
	  ...
	  drawHelper.on("areaCreated", function (e) {
	    if (e.multSelete) {
	      _this.multSetEdited(e.entity);
	    }
	  });
	  this.visible = false;
	  this.mousePos = undefined;
	...
	exports.default = MultSelete;


	function inLonlat(interval, point, type) {
	  var inArea = false;
	  switch (type) {
	    case "lonlat":
	      if (point[0] > interval[0] && point[0] < interval[1] && point[1] > interval[2] && point[1] < interval[3]) {
	        inArea = true;
	      }
	      return inArea;
	    case "lonlats":
	      for (var i = 0; i < point.length; i++) {
	        var lonlat = point[i];
	        if (lonlat[0] > interval[0] && lonlat[0] < interval[1] && lonlat[1] > interval[2] && lonlat[1] < interval[3]) {
	          inArea = true;
	        } else {
	          return false;
	        }
	    ...
	    case "positions":
	      for (i = 0; i < point.length; i++) {
	        lonlat = (0, _util.cartesianToLonlatNoHeight)(point[i]);
	        if (lonlat[0] > interval[0] && lonlat[0] < interval[1] && lonlat[1] > interval[2] && lonlat[1] < interval[3]) {
	          inArea = true;
	        } else {
	          return false;
	 ...
	 * @param {*} entity
	 */
	function inRangeEntity(interval, entity) {
	  switch (entity.type) {
	    case _Types2.default.SPACE_POLYGON:
	    case _Types2.default.CLASSIFY_POLYGON:
	    case _Types2.default.PROJ_POLYGON:
	    ...
	    case _Types2.default.GROUND_POLYLINE:
	    case _Types2.default.WALL:
	      if (inLonlat(interval, entity.positions, "positions")) {
	        entity.drawHelper._editor.setEditable(entity, true);
	        return entity;
	      }
	      break;
	    case _Types2.default.CIRCLE:
	      if (inLonlat(interval, [entity.center], "positions")) {
	        entity.drawHelper._editor.setEditable(entity, true);
	        return entity;
	      }
	      break;
	    // case Types.TEXT_MARKER:
	    // case Types.IMAGE_MARKER:
	    // case Types.LABEL_MARKER:
	    // case Types.FLAG_MARKER:
	    //   return entity;
	    case _Types2.default.GROUND_TEXT:
	      if (inLonlat(interval, [entity.startPoint, entity.endPoint], "lonlats")) {
	        entity.drawHelper._editor.setEditable(entity, true);
	        return entity;
	      }
	      break;
	    case _Types2.default.ICON:
	      if (inLonlat(interval, entity.lonlat, "lonlat")) {
	        entity.drawHelper._editor.setEditable(entity, true);
	        return entity;
	      }
	      break;
	  ...
	  if (entity.custom && entity.type.length > 1 && entity.type.search("GV") > -1 && entity._primitive) {
	    if (inLonlat(interval, entity.custom, "lonlats")) {
	      entity.drawHelper._editor.setEditable(entity, true);
	      return entity;
	    }
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function startDrawingCircle(options) {
	  ...
	  function finishDrawing(center, radius) {
	    ...
	    _self._plots.set(circle.id, circle);
	  }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = startDrawingArea;
	...
	function startDrawingArea(options) {
	  ...
	  this.startDrawing(function () {
	    ...
	    earth.off("leftDown", onLeftClick);
	    earth.off("mouseMove", onMouseMove);
	    earth.off("leftUp", onDoubleClick);
	  });
	  ...
	  var positions = [];
	  var pictureXY = [];
	  earth.on("leftDown", onLeftClick);
	  earth.on("mouseMove", onMouseMove);
	  earth.on("leftUp", onDoubleClick);
	  ...
	  function onLeftClick(event) {
	    ...
	    _self._scene.screenSpaceCameraController.enableTranslate = false;
	  }
	  function onMouseMove(event) {
	    var position = event.position;
	    var windowPos = {
	  ...
	  function onDoubleClick(event) {
	    ...
	    _self._scene.screenSpaceCameraController.enableTranslate = true;
	  }
	    ...
	    if (event.position && event.position !== null) {
	      ...
	      if (cartesian && delta > 300) {
	        if (options.type === _Types2.default.CLASSIFY_POLYGON) {
	          ...
	          poly.height = height - 10;
	          poly.extrudedHeight = height + 40;
	          options.height = height - 10;
	          options.extrudedHeight = height + 40;
	        }
	        if (positions.length === 0) {
	          positions.push(cartesian.clone());
	          points.addPoint(positions[0]);
	      ...
	      if (cartesian) {
	        switch (options.type) {
	          ...
	          case _Types2.default.FLAG_MARKER:
	            ...
	            break;
	          case _Types2.default.TEXT_MARKER_NEW:
	            marker = new _TextMarkerNew2.default(cartesian, _extends({}, options, {
	              drawHelper: _self
	            })).addTo(_self.features);
	            break;
	        }
	        ...
	        _self.stopDrawing();
	        _self._plots.set(marker.id, marker);
	        earth.off("click", onLeftClick);
	        earth.off("mouseMove", onMouseMove);
	      }
	    }
	    ...
	    if (position && position !== null) {
	      if (positions.length < 2) {} else {
	        ...
	        if (cartesian) {
	          ...
	          _self.stopDrawing();
	          _self._plots.set(rectangle.id, rectangle);
	          earth.off("click", onLeftClick);
	          earth.off("mouseMove", onMouseMove);
	          earth.off("doubleClick", onDoubleClick);
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = startDrawingModel;
	 ...
	 * @param {*} options
	 */
	function startDrawingModel(options) {
	  options = (0, _util.copyOptions)(options, {});
	  options.id = options.id || GeoVis.createGuid();
	  ...
	  function onLeftClick(event) {
	    if (event.position != null) {
	      ...
	      if (cartesian) {
	        var model = new _Model2.default(cartesian, _extends({}, options, {
	          drawHelper: _self
	        })).addTo(_self.features);
	        ...
	        _self.stopDrawing();
	        _self._plots.set(model.id, model);
	  ...
	  function onMouseMove(event) {
	    ...
	    if (position != null && options.contineDraw) {
	      tooltip.showAt(windowPos, "<p>点击放置图标，右键结束</p>");
	    } else if (position != null && !options.contineDraw) {
	      tooltip.showAt(windowPos, "<p>点击放置图标</p>");
	    }
	  }
	}
