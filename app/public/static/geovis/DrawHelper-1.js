...
/***/ (function(module, exports, __webpack_require__) {
	...
	window.DrawHelper = _plot2.default;
	exports.DrawHelper = _plot2.default;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _plotsList = __webpack_require__(86);

	var _plotsList2 = _interopRequireDefault(_plotsList);
	...
	var MainPlot = function (_Main) {
	  _inherits(MainPlot, _Main);

	  function MainPlot(viewer, options) {
	    _classCallCheck(this, MainPlot);

	    var _this = _possibleConstructorReturn(this, (MainPlot.__proto__ || Object.getPrototypeOf(MainPlot)).call(this, viewer, options));

	    _this.startDrawingPlot = Plot.startDrawingPlot;
	    _this.startDrawingIcon = Plot.startDrawingIcon;
	    _this.startDropingIcon = Plot.startDropingIcon;
	    _this.startDropingPlot = Plot.startDropingPlot;

	    _this.animators = new Plot.AnimatorGroup();
	    _this.PLOT_WASM_URL = window.PLOT_WASM_URL = options.wasm || "127.0.0.1:8003";
	    _this.startProtoBuf();
	    return _this;
	  }

	  _createClass(MainPlot, [{
	    key: "startProtoBuf",
	    value: function () {
	        ...
	        return _regenerator2.default.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                _context.next = 2;
	                return Plot.createProtoType();

	              case 2:
	                this.ProtoType = _context.sent;
	                _context.next = 5;
	                return Plot.createSocketConnection(this.PLOT_WASM_URL);

	              case 5:
	                this.socketConnection = _context.sent;

	                this.socketConnection.onmessage = Plot.messageHandler;
	      ...
	      function startProtoBuf() {
	        return _ref.apply(this, arguments);
	      }

	      return startProtoBuf;
	    }()
	  }, {
	    key: "destoryProtoBuf",
	    value: function destoryProtoBuf() {
	...
	_main2.default.PlotPrimitive = Plot.PlotPrimitive;
	_main2.default.IconPrimitive = Plot.IconPrimitive;
	_main2.default.plotsList = _plotsList2.default;
	_main2.default.Types = _Types2.default;
	exports.default = Plot.wrapEvented(MainPlot);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _wrapEvented = __webpack_require__(11);
	...
	var _compute = __webpack_require__(12);
	...
	var _serialize = __webpack_require__(14);
	...
	Object.defineProperty(exports, "createProtoType", {
	  enumerable: true,
	  get: function get() {
	    return _websocket.createProtoType;
	  }
	});
	Object.defineProperty(exports, "createSocketConnection", {
	  enumerable: true,
	  get: function get() {
	    return _websocket.createSocketConnection;
	  }
	});
	Object.defineProperty(exports, "messageHandler", {
	  enumerable: true,
	  get: function get() {
	    return _websocket.messageHandler;
	  }
	});
	...
	var _AnimatorGroup = __webpack_require__(60);

	Object.defineProperty(exports, "AnimatorGroup", {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_AnimatorGroup).default;
	  }
	});
	...
	var _MeasureTool = __webpack_require__(71);
	...
	var _PlotCopy = __webpack_require__(72);
	...
	Object.defineProperty(exports, "IconPrimitive", {
	  enumerable: true,
	  get: function get() {
	...
	Object.defineProperty(exports, "PlotPrimitive", {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_PlotShape).default;
	  }
	});
	...
	var _startDrawingCircle = __webpack_require__(73);
	...
	var _startDrawingPolygon = __webpack_require__(74);
	...
	var _startDrawingPolyline = __webpack_require__(75);
	...
	var _startDrawingPolyshape = __webpack_require__(76);
	...
	var _startDrawingWall = __webpack_require__(77);
	...
	var _startDrawingAngle = __webpack_require__(78);
	...
	var _startDrawingCutFill = __webpack_require__(79);
	...
	var _startDrawingVisibility = __webpack_require__(80);
	...
	var _startDrawingMarker = __webpack_require__(82);
	...
	var _startDrawingPlot = __webpack_require__(83);

	Object.defineProperty(exports, "startDrawingPlot", {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_startDrawingPlot).default;
	  }
	});

	var _startDrawingRect = __webpack_require__(87);
	...
	var _startDrawingIcon = __webpack_require__(88);

	Object.defineProperty(exports, "startDrawingIcon", {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_startDrawingIcon).default;
	  }
	});

	var _startDrawingDragMarker = __webpack_require__(89);
	...
	var _startDropingIcon = __webpack_require__(91);
	...
	var _startDropingPlot = __webpack_require__(92);

	Object.defineProperty(exports, "startDropingPlot", {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_startDropingPlot).default;
	  }
	});

	var _startDrawingGroundText = __webpack_require__(93);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _geographiclib = __webpack_require__(13);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _plotsList = __webpack_require__(16);
	...
	_plotsList2.default.plots.map(function (plot) {
	  Types[plot.id] = plot.id;
	});
...
/***/ (function(module, exports) {
	...
	var plots = [{
	  ...
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV00087" //error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV00088" //error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV00089" //ok
	  ...
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV00092" // ok  but 纯多色 且绘制过程与之后颜色不同
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV00150" // ok  but  纯多色
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV00151" // ok  but 纯多色
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV00152" // ok  but  多色和虚线
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV00164" // ok  but  纯多色
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV00165" // ok  but  多色和虚线
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV00166" //ok
	  ...
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV00183" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV00184" //error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV00185" // ok
	  ...
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV12500" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV12501" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV12502" //ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV13700" // ok
	  ...
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV15201" //ok  but 插值数不够
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV15202" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV15800" // ok
	  ...
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV16500" // error 仨点后失效  无参照
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV16700" //error 俩点后失效  无参照
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV16900" // error 俩点后失效  无参照
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV17400" // error 仨点后失效 无参照
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV17401" //ok  无参照
	  ...
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV17800" // error 仨点后失效  无参照
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV17801" //error 仨点后失效  无参照
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV17802" // error 仨点后失效  无参照
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV17803" // error 仨点后失效  无参照
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV17804" //error 仨点后失效  无参照
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV17805" // error 仨点后失效  无参照
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV17806" // error 仨点后失效 无参照
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV20300" //ok
	  ...
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV21501" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV21502" //ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV21503" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV21504" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV21600" //ok
	  ...
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV21800" //error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV21900" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV22000" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV22103" //ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV22200" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV23400" //ok
	  ...
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV23500" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV23600" //error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV23700" //error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV23800" //ok
	  ...
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV23901" //error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV23902" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV24700" //ok
	  ...
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV25300" //error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV25301" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV25400" // ok  but  子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV25500" //ok
	  ...
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV25700" // error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV25701" // error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV25702" // error 仨点后失效 无返回值或绘制后崩溃
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV25703" // error 仨点后失效 无返回值或绘制后崩溃
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV25704" // error 仨点后失效  无返回值或绘制后崩溃
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV25705" // error 无返回值或绘制后崩溃
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV25800" // ok
	  ...
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV26501" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV26502" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV26503" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV26600" // ok  but 纯虚线
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV26601" // ok  but 纯虚线 仍然显实线
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV26700" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV26800" //error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV26900" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV27000" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV27001" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV27100" // error 俩点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV27300" // error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV27301" // error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV27700" //error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV27701" // error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV27900" //error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV27901" //error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV27902" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 4,
	  id: "GV28000" //error 四点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV28100" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV28200" // error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV28201" //error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV28300" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV28301" //error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV28400" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV28900" //ok
	  ...
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV29100" // error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV29101" //error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV29102" // error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV29200" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV29201" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV29400" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV29401" //error 俩点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV29500" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV29800" //ok
	  ...
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV29903" // error 俩点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV30000" // ok
	  ...
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV30001" //ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV30002" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV30003" // ok   特殊点  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV30100" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV30102" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV30200" //error  无返回值或绘制后崩溃
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV30201" // error  无返回值或绘制后崩溃
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV30402" //ok
	  ...
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV30801" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV30802" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV31300" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV31301" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV31302" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV31303" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV31304" //error 无返回值或绘制后崩溃
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV31400" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV31401" //error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV31600" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV31601" //error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV31700" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV31701" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV31800" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV31801" //error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV31802" // error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV31803" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV32900" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV33400" //error   无返回值或绘制后崩溃
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV33401" //error   无返回值或绘制后崩溃
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV33402" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV33403" // error 俩点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV33404" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV33700" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV34300" // error 俩点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV34400" //error 俩点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV34500" // error 俩点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV34501" // error 俩点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV34700" //ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV34800" // error 俩点后失效  无返回值或绘制后崩溃
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV34801" // error 俩点后失效  无返回值或绘制后崩溃
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV34900" //ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV34901" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV34902" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV35000" //ok
	  ...
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV35200" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV35304" //ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV35500" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV35601" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV36300" //error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV36301" //error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV36302" //error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV36303" //error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV36304" // ok
	  ...
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV36400" //ok  but 固定形状失效
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV36401" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV36600" //error 俩点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV36700" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV36800" // error 特殊点 无返回值或绘制后崩溃
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV36900" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV37100" // error 俩点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV37200" // error 俩点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV37300" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV37301" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV37600" // error 仨点后失效  无参照
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV37601" // error 仨点后失效  无参照
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV37700" // error 仨点后失效  无参照
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV38600" // ok   无参照
	  ...
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV38700" // error 仨点后失效  无参照
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV39000" // error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV39101" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV39500" // error 俩点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV39600" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV39800" // error  无返回值或绘制后崩溃
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV39801" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV39802" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV40000" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV40100" //error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV40101" // error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV40900" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV41000" // error 仨点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV41100" // ok   无参照
	  ...
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV42200" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV42400" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV42500" //error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV42700" //ok
	  ...
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV44200" // ok  but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 3,
	  id: "GV44300" // error 仨点后失效   but 子标缺失
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV44400" //ok
	  ...
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV61004" // ok  but 纯虚线
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV61005" // ok  but 纯虚线
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV61006" // ok
	  ...
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV61009" // error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 2,
	  id: "GV61010" //error 俩点后失效
	}, {
	  minPoints: 2,
	  maxPoints: 1000,
	  id: "GV61011" //ok
	        ...
	        switch (_context2.prev = _context2.next) {
	          case 0:
	            return _context2.abrupt("return", new Promise(function (resolve, reject) {
	              protobuf.load("./static/geovis/schema.proto", function (err, root) {
	                if (err) {
	                  console.error(err);
	                  return;
	                }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Angle = __webpack_require__(81);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function (options) {
	  var onMouseMove = function () {
	    var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(event) {
	      var position, windowPos, currentTime, delta, cartesian, cartographic, len, lat, height, point, str;
	      return _regenerator2.default.wrap(function _callee$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	            ...
	            case 6:
	              ...
	              tooltip.showAt(windowPos, "<p>点击以增加第一个控制点</p>");
	              _context.next = 28;
	              break;

	            case 11:
	              cartesian = (0, _pickPosition2.default)(scene, event, options.pickTileset);
	              ...
	              cartographic = GeoVis.Cartographic.fromCartesian(cartesian);
	              len = GeoVis.Math.toDegrees(cartographic.longitude);
	              lat = GeoVis.Math.toDegrees(cartographic.latitude);
	              height = cartographic.height;
	              point = [len, lat, height];
	              ...
	              _context.next = 23;
	              return (0, _websocket.getGeomtry)(positions, options.type, poly);

	            case 23:
	              poly.custom = positions;
	              poly._createPrimitive = true;
	              if (positions.length > minPoints) {
	                str = "<p>双击可结束绘制</p>";
	              } else {
	  ...
	  var primitives = this._primitives;
	  var tooltip = this._tooltip;
	  // var mm=getGeomtry(1,"222")
	  var poly;

	  var plot = _Plots2.default[options.type];
	  if (!plot) {
	    return;
	  }
	  var minPoints = plot.minPoints;
	  var maxPoints = plot.maxPoints;
	  var animationType = plot.animationType;
	  if (minPoints === maxPoints) {
	    minPoints = minPoints - 1;
	  }

	  options.animationType = animationType;
	  poly = new _PlotShape2.default(_extends({}, options, { drawHelper: _self }));
	  poly.asynchronous = false;
	  primitives.add(poly);
	  ...
	  var positions = [];
	  var clickSum = 0; // 用于初始点创建排除及后续点判断
	  var points = _self.points;
	  earth.on("click", onLeftClick);
	  earth.on("mouseMove", onMouseMove);
	  earth.on("doubleClick", onDoubleClick);
	  ...
	  function onDoubleClick(event) {
	    var position = event.position;
	    if (position && position !== null) {
	      if (positions.length < minPoints + 1) {} else {
	        var cartesian = (0, _pickPosition2.default)(scene, event, options.pickTileset);
	        if (cartesian) {
	          var length = poly.custom.length;
	          if (poly.custom[length - 1][0] === poly.custom[length - 2][0]) {
	            poly.custom.pop();
	          }
	          if (typeof options.callback === "function") {
	            options.callback(poly);
	...
	var _Plots = __webpack_require__(84);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	//  import PlotAnalysis from "./tools/PlotAnalysis"
	var Plots = [];
	_plotsList2.default.plots.map(function (plot) {
	  Plots[_Types2.default[plot.id]] = {
	    minPoints: plot.minPoints,
	    maxPoints: plot.maxPoints,
	    id: plot.id
	    // algorithm: PlotAnalysis.createAlgorithm
	  };
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PlotTypes = _Types2.default;

	_plotsList2.default.plots.map(function (plot) {
	  PlotTypes[plot.id] = plot.id;
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function startDrawingIcon(options) {
	  options = (0, _util.copyOptions)(options, {});
	  options.id = options.id || GeoVis.createGuid();
	  // if (options.height === undefined && options.width) {
	  //   var img = new Image();
	  ...
	  function onLeftClick(event) {
	    if (event.position != null) {
	      ...
	      if (cartesian) {
	        ...
	        icon = new _Icon2.default(cartesian, _extends({}, options, {
	          drawHelper: _self
	        })).addTo(_self.features);
	        _self.fire("created", {
	          entity: icon
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _DragMarker = __webpack_require__(90);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = startDropingPlot;
	...
	function startDropingPlot(options) {
	  options = options || {};
	  var _self = this;
	  var primitives = this._primitives;
	  var tooltip = this._tooltip;
	  ...
	  dropIcon(options.positions);
	  function dropIcon(positions) {
	    if (positions) {
	      var plotGeometrys = plot.algorithm(positions, options.type, options);
	      poly.plotGeometrys = plotGeometrys;
	      poly.custom = positions;
	      poly._createPrimitive = true;
	      poly.setEditable();
	      _self.fire("created", {
