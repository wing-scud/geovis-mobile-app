...
define(['./when-cbf8cd21', './Check-35e1a91d', './Math-69007a69', './Cartesian2-43e3a3be', './Transforms-5b69e02c', './RuntimeError-f4c64df1', './WebGLConstants-95ceb4e9', './AttributeCompression-ea810287', './IndexDatatype-79bb407c', './IntersectionTests-efb488bd', './Plane-c6b92a10', './createTaskProcessorWorker', './EllipsoidTangentPlane-f87adb66', './OrientedBoundingBox-42978e6f', './Color-4ac764f0'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, AttributeCompression, IndexDatatype, IntersectionTests, Plane, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, Color) { 'use strict';
