      ...
      children: [
        {
          ...
          data: {
            ...
            layerURL: `https://webst01.is.autonavi.com/appmaptile?style=6&x={x}&y={y}&z={z}`,
            content: ""
            // 可选参数， bounding
          }
        },
        {
          ...
          data: {
            ...
            projection: "EPSG:900913",
            imgURL: "./data/LayerManager/img.jpg",
            layerURL: "http://wprd04.is.autonavi.com/appmaptile?lang=zh_cn&size=1&style=7&x={x}&y={y}&z={z}",
            minLevel: 3,
            content: ""
            // 可选参数， bounding
          }
