<template>
    <div>
      <gv-panel :width="500" title="转换工具" class="RoutePlan">
        <div class="mainPart">
          <el-tabs type="border-card" tab-click="handclick">
            <el-tab-pane label="坐标转换">
              <table>
                <tr>
                  <td>
                    坐标系
                ...
                <tr>
                  <td>
                    <el-select v-model="fromSystem">
                      <template v-for="system in systems">
                        <el-option :key="system" :value="system" :label="system"> </el-option>
                      </template>
                    </el-select>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <div class="valueInput">X:<el-input-number v-model="fromX" style="width:150px;margin-left:20px"></el-input-number></div>
                    <div class="valueInput">Y:<el-input-number v-model="fromY" style="width:150px;margin-left:20px"></el-input-number></div>
                    <!-- <div class="valueInput">z:<el-input-number v-model="fromZ" style="width:150px;margin-left:20px"></el-input-number></div> -->
                  </td>
                  <td>
                    <el-button @click="convertCoor" type="primary" round>提交</el-button>
                  </td>
                  <td>
                    <div class="valueInput">X:<el-input-number v-model="toX" style="width:150px;margin-left:20px"></el-input-number></div>
                    <div class="valueInput">Y:<el-input-number v-model="toY" style="width:150px;margin-left:20px"></el-input-number></div>
                    <!-- <div class="valueInput">z:<el-input-number v-model="toZ" style="width:150px;margin-left:20px"></el-input-number></div> -->
                  </td>
                </tr>
              </table>
            </el-tab-pane>
            <el-tab-pane label="地理编码">
              <GeocodeArea />
            </el-tab-pane>
            <el-tab-pane label="逆地理编码">
              <GeocodeArea />
            </el-tab-pane>
  ...
  import Vue from "vue";
  let drawHelper = window["drawHelper"];
  if (!drawHelper) {
    drawHelper = new DrawHelper(earthStore.earth, null);
    window["drawHelper"] = drawHelper;
  }
  const icons = [];
  import GeocodeArea from "./GeocodeArea.vue";
  ...
  const ConvertTool = Vue.extend({
    name: "ConvertTool",
    components: { GeocodeArea },
    data() {
      return {
        systems: ["CGCS:2000", "WGS84", "BJ54"],
        fromSystem: "",
        toSystem: "",
        fromX: 0,
        toX: 0,
