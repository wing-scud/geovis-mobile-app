import getMapVRenderer from "./MapVRenderer";
var MapVRenderer;
  ...
  createClass(layer, [
    ...
    },
    {
      ...
      value: function() {
        ...
        var eventHandler = new GeoVis.ScreenSpaceEventHandler(this.canvas);
        // 添加左键监听
        ...
        eventHandler.setInputAction(function(t) {
          self.innerMoveEnd();
        }, GeoVis.ScreenSpaceEventType.MIDDLE_UP);
    ...
    },
    {
      ...
      value: function() {
        ...
        canvas.style.zIndex = this.mapVOptions.zIndex || 1;
