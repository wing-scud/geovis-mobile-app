      ...
      <div class="mainPart">
        <el-tabs type="border-card" tab-click="handclick">
          ...
          <el-tab-pane label="地理编码">
            <GeocodeArea :reverse="false" />
          </el-tab-pane>
          <el-tab-pane label="逆地理编码">
            <GeocodeArea :reverse="true" />
          </el-tab-pane>
...
import CoorConvert from "./CoorConvert.vue";
import GeocodeArea from "./GeoCoder.vue";
...
const ConvertTool = Vue.extend({
  name: "ConvertTool",
  components: { CoorConvert, GeocodeArea },
  data() {
    return {
      // fromZ: 0,
      // toZ: 0,
